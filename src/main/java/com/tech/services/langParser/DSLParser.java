package com.tech.services.langParser;

import com.tech.services.DSLKeywordResolverService;
...
public class DSLParser {
    ...
    @Autowired
    private DSLKeywordResolverService keywordResolver;
    @Autowired
        ...
        listOfDslKeyword.stream()
                .forEach(
                        dslKeyword -> {
                            ...
                            DSLResolverService resolver = keywordResolver.getResolver(keyResolver).get();
